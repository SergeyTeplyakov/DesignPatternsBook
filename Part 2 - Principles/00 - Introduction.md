...
Изначально эти принципы были описаны несколько в ином порядке, и в архиве старины "дядюшки Боба" значатся под абревиатурой SOLDI. Через несколько лет они перекочевали в книгу ["Agile Software Development, Principles, Patterns, and Practices"](http://www.amazon.com/Software-Development-Principles-Patterns-Practices/dp/0135974445/), а со временем в аналогичную книгу с примерами на языке C# - ["Принципы, практики и методики гибкой разработки на языке C#"](http://www.ozon.ru/context/detail/id/5800704/), но в них порядок уже был иным и появились "цельные" (SOLID) принципы, звучность названия которых в немалой степени обеспечили им успех.
...
**Anti-DIP – Принцип инверсии сознания или DI-головного мозга**. Интерфейсы выделяются для каждого класса и пачками передаются через конструкторы. Понять, где находится логика становится практически невозможно.оположной точки зрения”.
