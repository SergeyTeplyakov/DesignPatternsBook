...
Классическим решением задачи связи нижних слоев с верхними является паттерн Наблюдатель (*). Классу достаточно потребовать от "верхнего уровня" делегат, который он будет использовать по мере необходимости. При этом логически, управление будет передано с нижнего уровня на верхний, однако знать о том, "что" будет происходить при вызове этого делегата, текущий класс не будет.
